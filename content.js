export const values = [
    {
        'header': 'Choose positivity and happiness',
        'body': [
    ...
    {
        'header': 'Default to transparency',
        'body': [
    ...
    {
        'header': 'Have a focus on self improvement',
        'body': [
    ...
    {
        'header': 'Listen first, then listen more',
        'body': [
    ...
    {
        'header': 'Have a bias towards clarity',
        'body': [
    ...
    {
        'header': 'Live smarter, not harder',
        'body': [
    ...
    {
        'header': 'Show gratitude',
        'body': [
            'You regularly stop and are grateful for your circumstances',
            'You are grateful for the work co-workers do to push the company forward and to help you move faster',
    ...
    },
    {
        ...
        'body': [
            ...
            'You strive to provide the best solution, even if that means foregoing proﬁt',
